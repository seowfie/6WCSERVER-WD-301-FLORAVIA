...
// 🖼️ SAFE Image Helper (Copy and replace your old function with this)
function getImageUrl(path) {
  // 1. Use a public internet link for missing images (Stops the "placeholder.jpg" error)
  ...
  // Note: For this to work perfectly, move your local images to the "public" folder.
  return clean;
}
