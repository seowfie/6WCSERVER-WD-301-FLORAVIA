...
// 🌸 SAFE Image Resolver (No local files required)
function resolveImage(imagePath) {
  // 1. If image is missing, return a public internet placeholder
  // This prevents the build from crashing on "placeholder.jpg"
  ...
  // We use the path string directly.
  // IMPORTANT: For this to work, ensure your images (like "gallery1.jpg") are in the "public" folder.
